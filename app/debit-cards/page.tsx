...
const CARDS = [
  {
    ...
    expiry: "09/26",
    logo: card, // <-- corrected: pass imported card image directly
    featured: true,
    info: "mastercard",
...
function CardVisual({
  ...
  name: string
  expiry: string
  logo: any // accept Next.js image import, not only string
  gradient: string
}) {
  return (
    <div
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <Image
          ...
          draggable={false}
          style={{ minWidth: 40, minHeight: 40, maxWidth: 56, maxHeight: 56 }}
        />
        <span
          className="uppercase"
          style={{
      ...
      <div className="mt-7 md:mt-10 lg:mt-12">
        ...
        <div
          style={{
            ...
            fontWeight: 900,
            fontSize: "clamp(1.08rem, 4vw, 2rem)",
        ...
        <div className="flex flex-wrap justify-between items-center w-full gap-x-3 gap-y-2">
          <div>
            ...
            <div
              style={{
                fontFamily: '"SF Pro Display", "Segoe UI", "Inter", Arial, sans-serif',
                fontWeight: 800,
                fontSize: "clamp(0.7rem, 2vw, 1.08rem)",
            ...
            <div
              style={{
                fontFamily: '"SF Pro Display", "Segoe UI", "Inter", Arial, sans-serif',
                fontWeight: 600,
                fontSize: "clamp(0.7rem, 2vw, 1.03rem)",
          ...
          {/* Only render if logo is not null or empty */}
          {(logo) && (
